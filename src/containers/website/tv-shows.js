                       ...
                       <div id="headerslider" class="carousel slide"> 
                           ...
                           <div class="carousel-inner" role="listbox">
                               <div class="item active">
                                   <div class="fill banner-ship-img" style={{backgroundImage:`url("web-assets/img/banner-img/serials3.jpg")`}}>
                                    <div class="bs-slider-overlay"></div>
                                       <div class="container movie-slider-container"> 
                                           <div class="row">
                                                <div class="col-sm-12 movie-slider-content"> 
                                                   <div class="slider-content" >
                                                       <div class="title" data-animation="animated bounceInRight" >Vikings</div>
                                                       <div><span class="movie-about views">14+</span><span class="movie-about">2h 10m</span></div>
                                                       <div class="title-detail">
                                                           <p>
                                                                Vikings transports us to the brutal and mysterious world of Ragnar Lothbrok, a Viking warrior and 
                               ...
                               <div class="item">
                                   <div class="fill  banner-ship-img2" style={{backgroundImage:`url("web-assets/img/banner-img/tvshow3.jpg")`}}>
                                    <div class="bs-slider-overlay"></div>
                                       <div class="container movie-slider-container"> 
                                           <div class="row">
                                                <div class="col-sm-12 movie-slider-content"> 
                                                   <div class="slider-content" >
                                                       <div class="title" data-animation="animated bounceInRight" >Jupiter Ascending </div>
                                                       <div><span class="movie-about views">16+</span><span class="movie-about">2h 40m</span></div>
                                                       <div class="title-detail">
                                                           <p>
                                                                Jupiter Jones works as a servant and cleans other people's houses. Her life changes when Caine, an ex-military 
                                                                hunter, informs her that she must fight to protect the Earth from a destructive force.
                                                           </p>
                                                       </div>
                                                       <div class="slide_right" data-animation="animated bounceInRight">
                               ...
                               <div class="item">
                                   <div class="fill  banner-ship-img3" style={{backgroundImage:`url("web-assets/img/banner-img/tvshow1.jpg")`}} data-bg-image="images/header/header.png">
                                    <div class="bs-slider-overlay"></div>
                                       <div class="container movie-slider-container"> 
                                           <div class="row">
                                                <div class="col-sm-12 movie-slider-content"> 
                                                   <div class="slider-content" >
                                                       <div class="title" data-animation="animated bounceInRight" >9 </div>
                                                       <div><span class="movie-about views">16+</span><span class="movie-about">2h 40m</span></div>
                                                       <div class="title-detail">
                                                           <p>
                                                           After an apocalyptic war between humans and machines, the world is completely destroyed and void 
                                                           of human life. However, a ragdoll awakens in this world and it holds the key to humanity's salvation.
                                                           </p>
                                                       </div>
                                                       <div class="slide_right" data-animation="animated bounceInRight">
