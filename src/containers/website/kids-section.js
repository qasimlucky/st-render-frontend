                                   ...
                                   <div class="fill">
                                       ...
                                       <div class="container movie-slider-container section-3rd"> 
                                           <div class="row third-row">
                                               <div class="third-col">
                                                   <div class="courses-details video-link">
                                                       <div class="courses-details-images">
                                                               <img src="web-assets/img/banner-img/kids1.jpg" alt="Courses Details"/>
                                               ...
                                               <div class="col-sm-12 movie-slider-content third-col" style={{backgroundImage: `url("web-assets/img/banner-img/kids1.jpg")`}}> 
                                       ...
                                       <div class="container movie-slider-container section-3rd"> 
                                           <div class="row third-row">
                                               <div class="third-col">
                                                   <div class="courses-details video-link">
                                                       <div class="courses-details-images">
                                                               <img src="web-assets/img/banner-img/movie04.jpg" alt="Courses Details"/>
                                                           <a class="courses-play"  target="_blank">
                                                           <i class="fa-solid fa-play play"></i>
                                                           </a>
                                                       </div>
                                               ...
                                               <div class="col-sm-12 movie-slider-content third-col" style={{backgroundImage: `url("web-assets/img/banner-img/movie04.jpg")`}}> 
                                                   <div class="slider-content" >
                                       ...
                                       <div class="container movie-slider-container section-3rd"> 
                                           <div class="row third-row">
                                               <div class="third-col">
                                                   <div class="courses-details video-link">
                                                       <div class="courses-details-images">
                                                               <img src="web-assets/img/banner-img/movie03.jpg" alt="Courses Details"/>
                                                           <a class="courses-play"  target="_blank">
                                                               <i class="fa-solid fa-play play"></i>
                                                           </a>
                                                       </div>
                                               ...
                                               <div class="col-sm-12 movie-slider-content third-col" style={{backgroundImage: `url("web-assets/img/banner-img/movie03.jpg")`}}> 
                                                   <div class="slider-content" >
